                ...
                <span className="relative flex h-6 w-6 items-center justify-center">
                  <span
                    className={`pointer-events-none absolute inset-0 rounded-full border opacity-40 ${
                      mounted && theme === "dark" ? "border-white/40" : "border-neutral-400/60"
                    }`}
                  />
                  <span
                    className={`h-3 w-3 rounded-full transition-all duration-500 ${
                      mounted && theme === "dark" ? "bg-white" : "bg-neutral-900"
                    }`}
                  />
                </span>
                {mounted ? (theme === "dark" ? "Night" : "Day") : "Day"} mode
              </button>
            </div>
...
export default BentoWorkflowSection;
export { BentoWorkflowSection };
